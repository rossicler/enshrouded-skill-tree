    ...
    >
      ...
      <span
        ...
        className={classNames(
          ...
          "group-hover:from-[#55555b] group-hover:via-[#3d3d42] group-hover:to-[#303035]",
          "group-hover:border-[#6a6a70] group-hover:border-t-[#78787f]",
          "group-active:from-[#2a2a2f] group-active:via-[#252528] group-active:to-[#202025]",
          "group-active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]",
          "group-active:border-t-[#4a4a50] group-active:border-b-[#1a1a1e]",
          "transition-all duration-150"
        )}
      >
      ...
      <span
        className={classNames(
          "relative z-10 font-semibold tracking-wide text-sm",
          "text-[#e8d5a3] drop-shadow-[0_0_4px_rgba(202,152,3,0.4)]",
          "group-hover:text-[#f0e0b5] group-hover:drop-shadow-[0_0_6px_rgba(202,152,3,0.6)]"
        )}
      >
        {children}
      </span>
