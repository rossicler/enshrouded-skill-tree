    ...
    types: {
        ...
        RADIANT_AURA: {
            ...
            perLevel: {
                value: 2,
                value2: 1,
                label: "<b>{{value}}</b> meters range and <b>{{value2}} Fire</b> damage per Intelligence per level",
            },
        },
        WATER_AURA: {
            name: "WATER AURA",
        ...
        COUNTERSTRIKE: {
            ...
            perLevel: {
                value: 8,
                value2: 20,
                label: "<b>{{value}}%</b> chance and <b>{{value2}}%</b> reflected damage per level",
            },
        },
        TERROR: {
            name: "TERROR",
        ...
        QUICK_CHARGE: {
            name: "QUICK CHARGE",
            description: [
                "Cast Time of spells is reduced by <b>{{value}}%</b>.",
            ],
            color: "blue",
            cost: 1,
            maxLevel: 3,
        ...
        THIS_IS_THE_WAY: {
            ...
            description: [
                "Magic weapon damage is increased by <b>{{value}}%</b>.",
            ],
            color: "blue",
            cost: 1,
            maxLevel: 3,
        ...
        ARSONIST: {
            name: "ARSONIST",
            description: ["All <b>Fire</b> damage is increased by <b>{{value}}%</b>."],
            color: "blue",
            cost: 2,
            maxLevel: 3,
            perLevel: {
        ...
        THUNDER: {
            name: "THUNDER",
            description: ["All <b>Shock</b> damage is increased by <b>{{value}}%</b>."],
            color: "blue",
            cost: 2,
            maxLevel: 3,
            perLevel: {
        ...
        DARK_ARTS: {
            name: "DARK ARTS",
            description: ["All <b>Shroud damage</b> is increased by <b>{{value}}%</b>."],
            color: "blue",
            cost: 2,
            maxLevel: 3,
            perLevel: {
        ...
        UNITY: {
            ...
            perLevel: {
                value: 10,
                value2: 2,
                label: "<b>{{value}}%</b> chance and <b>{{value2}}%</b> of maximum Mana per level",
            },
        },
        WAND_MASTER: {
        ...
        SOUL_LEECH: {
            ...
            perLevel: {
                value: 5,
                value2: 15,
                label: "<b>{{value}}</b> meters range and <b>{{value2}}</b> Mana per level",
            },
        },
        SHINY_PLATES: {
            name: "SHINY PLATES",
            description: ["Equipped armor grants <b>{{value}}%</b> increased Magical Armor"],
            color: "red",
            cost: 1,
            maxLevel: 3,
            perLevel: {
        ...
        TITAN_EDGE: {
            name: "TITAN EDGE",
            description: ["Two-Handed Greatsword damage is increased by <b>{{value}}%</b>."],
            color: "red",
            cost: 2,
            maxLevel: 3,
            perLevel: {
        ...
        BACKSTAB_MASTERY: {
            name: "BACKSTAB MASTERY",
            description: ["<b>Backstab</b> damage is increased by <b>{{value}}%</b>."],
            color: "green",
            cost: 1,
            maxLevel: 3,
            perLevel: {
        ...
        RUNNER: {
            ...
            perLevel: {
                value: 5,
                value2: 5,
                label: "<b>{{value}}%</b> Speed and <b>{{value2}}%</b> cost reduction per level",
            },
        },
        WANDERLUST: {
            name: "WANDERLUST",
        ...
        ARACHNOID: {
            name: "ARACHNOID",
            description: ["Stamina cost while climbing is reduced by <b>{{value}}%</b>."],
            color: "green",
            cost: 1,
            perLevel: {
                value: 20,
        ...
        REBOUND: {
            name: "REBOUND",
            description: ["Base Stamina Regeneration is increased <b>{{value}}%</b>."],
            color: "green",
            cost: 2,
            maxLevel: 3,
            perLevel: {
        ...
        COUNTER_BATTERY: {
            ...
            description: ["Damage against <b>ranged</b> enemies is increased by <b>{{value}}%</b>."],
            color: "green",
            cost: 1,
            maxLevel: 3,
            perLevel: {
        ...
        EAGLES_BANE: {
            name: "EAGLES BANE",
            description: ["Damage against <b>flying</b> enemies is increased by <b>{{value}}%</b>."],
            color: "green",
            cost: 1,
            maxLevel: 3,
            perLevel: {
        ...
        SILENT_STRIDE: {
            name: "SILENT STRIDE",
            description: ["Increases your movement speed while <b>sneaking</b> by <b>{{value}}%</b>."],
            color: "green",
            cost: 1,
            maxLevel: 3,
            perLevel: {
        ...
        BLESSED_ARROWS: {
            name: "BLESSED ARROWS",
            description: [
                "Critical Strikes with Bowsrestore <b>{{value}}</b> mana.",
            ],
            color: "green",
            cost: 1,
            maxLevel: 3,
